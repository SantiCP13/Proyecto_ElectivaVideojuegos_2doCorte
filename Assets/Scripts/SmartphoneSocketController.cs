...
public class SmartphoneSocketController : MonoBehaviour
{
    ...
    private void SendCurrentInput()
    {
        ...
        message.x = moveJoystick != null ? moveJoystick.Horizontal : 0f;
        message.z = moveJoystick != null ? moveJoystick.Vertical : 0f;
        message.yaw = rotationJoystick != null ? rotationJoystick.Horizontal : 0f;
